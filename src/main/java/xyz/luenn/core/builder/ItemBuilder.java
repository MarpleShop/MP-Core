package xyz.luenn.core.builder;
...
import xyz.luenn.core.MarpleCore;
...
public class ItemBuilder {
    ...
    public ItemBuilder setNBT(String key, String value) {
        itemMeta.getPersistentDataContainer().set(new NamespacedKey(JavaPlugin.getProvidingPlugin(MarpleCore.class), key), PersistentDataType.STRING, value);
        return this;
    }
    ...
    public ItemBuilder removeNBT(String key) {
        itemMeta.getPersistentDataContainer().remove(new NamespacedKey(JavaPlugin.getProvidingPlugin(MarpleCore.class), key));
        return this;
    }
